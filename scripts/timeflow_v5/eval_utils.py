...
CHECKPOINT_PATH = OUTPUT_DIR / "best_flow_v5.pt"
...
def build_model(checkpoint: dict, device: torch.device) -> GWFlowModelV5:
    model = GWFlowModelV5(
...
def build_split_dataset(checkpoint: dict, split_name: str) -> GWDatasetV5:
