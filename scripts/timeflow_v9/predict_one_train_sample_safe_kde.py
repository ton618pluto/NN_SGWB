...
OUTPUT_NAME_TEMPLATE = "train_sample_posterior_kde_v9_sample{sample_index:05d}.png"
...
def print_posterior_summary(parameter_names: list[str], posterior_stats: list[dict[str, float]]) -> None:
    header = f"{'param':<12}{'true':>14}{'mean':>14}{'err':>14}{'ci16':>14}{'ci84':>14}{'in68':>8}"
...
def plot_corner_kde(samples: np.ndarray, true_values: np.ndarray, output_path: Path) -> None:
    ...
    fig.suptitle(
        "Posterior joint distribution (KDE) for one v9 train sample\n"
