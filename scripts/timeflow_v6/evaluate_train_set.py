...
OUTPUT_FIG_NAME = "train_set_param_mae_v6.png"
OUTPUT_TXT_NAME = "train_set_metrics_v6.txt"
...
def plot_parameter_mae(
    ...
    ax.set_title("V6 model per-parameter MAE on train split", fontsize=13)
...
def main() -> None:
    ...
    progress = tqdm(range(eval_count), desc="Evaluating v6 train split", unit="sample")
