...
OUTPUT_NAME_TEMPLATE = "test_sample_posterior_kde_v6_sample{sample_index:05d}.png"
...
def plot_corner_kde(samples: np.ndarray, true_values: np.ndarray, output_path: Path) -> None:
    ...
    fig, axes = plt.subplots(dim, dim, figsize=(17, 17))
    ...
    fig.suptitle(
        "Posterior joint distribution (KDE) for one v6 test sample\n"
