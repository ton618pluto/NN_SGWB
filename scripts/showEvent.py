...
# 各个参数的分布
def save_individual_distributions(data, output_dir='events_distribution'):
    """
...
file_path = './parameter_sampling_train/v2/CBC_params_example00000.npz'
save_path = 'events_distribution/cbc_distributions18.png'
