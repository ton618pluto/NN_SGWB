...
OUTPUT_FIG_NAME = "test_set_param_mae_v8.png"
OUTPUT_TXT_NAME = "test_set_metrics_v8.txt"
...
def plot_parameter_mae(parameter_names: list[str], per_param_mae_mean: np.ndarray, per_param_mae_std: np.ndarray, output_path: Path) -> None:
    ...
    ax.set_title("V8 model per-parameter MAE on test split", fontsize=13)
...
def main() -> None:
    ...
    progress = tqdm(range(eval_count), desc="Evaluating v8 test split", unit="sample")
