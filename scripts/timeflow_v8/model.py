...
class GWFlowModelV8(nn.Module):
    def __init__(self, param_dim: int = 4, in_channels: int = 1, context_dim: int = 256, flow_layers: int = 6, flow_hidden_features: int = 256, flow_bins: int = 8, flow_tail_bound: float = 3.0) -> None:
        super().__init__()
        if NFLOWS_IMPORT_ERROR is not None:
            raise ModuleNotFoundError(
                "GWFlowModelV8 requires the 'nflows' package. Install it before running train_flow.py."
