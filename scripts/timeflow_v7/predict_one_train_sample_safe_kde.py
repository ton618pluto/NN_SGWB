...
OUTPUT_NAME_TEMPLATE = "train_sample_posterior_kde_v7_sample{sample_index:05d}.png"
...
def plot_corner_kde(samples: np.ndarray, true_values: np.ndarray, output_path: Path) -> None:
    ...
    fig, axes = plt.subplots(dim, dim, figsize=(14, 14))
    ...
    fig.suptitle(
        "Posterior joint distribution (KDE) for one v7 train sample\n"
