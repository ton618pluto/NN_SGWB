...
OUTPUT_FIG_NAME = "train_set_param_mae_v7.png"
OUTPUT_TXT_NAME = "train_set_metrics_v7.txt"
...
def plot_parameter_mae(parameter_names: list[str], per_param_mae_mean: np.ndarray, per_param_mae_std: np.ndarray, output_path: Path) -> None:
    ...
    ax.set_title("V7 model per-parameter MAE on train split", fontsize=13)
...
def main() -> None:
    ...
    progress = tqdm(range(eval_count), desc="Evaluating v7 train split", unit="sample")
