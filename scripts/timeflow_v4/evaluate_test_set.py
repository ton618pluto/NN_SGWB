...
OUTPUT_FIG_NAME = "test_set_param_mae_v4.png"
OUTPUT_TXT_NAME = "test_set_metrics_v4.txt"
...
def plot_parameter_mae(
    ...
    ax.set_title("V4 model per-parameter MAE on test split", fontsize=13)
...
def main() -> None:
    ...
    progress = tqdm(range(eval_count), desc="Evaluating v4 test split", unit="sample")
