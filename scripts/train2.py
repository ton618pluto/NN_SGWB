...
def train():
    ...
    train_path = './processed_data_train/v1/training_set5/H1_splits'
    val_path = './processed_data_val/v1/H1_splits'

    print(f"\n{'=' * 30}\n[初始化阶段] 开始准备归一化流训练环境\n{'=' * 30}")
    print(f"使用设备: {device}")

    train_dataset = GWDataset(train_path, show_progress=True, dataset_name="train")
